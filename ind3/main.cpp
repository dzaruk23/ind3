...
string vsPath1 = "C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\vertexPhong.shader";
string fsPath1 = "C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\fragmentPhong.shader";
...
void loadModels()
{
	...
	counts[i] = initVBO(VBO[i], VBN[i], VBT[i], IBO[i],
		"C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\obj\\Board.obj",
		v, 0.3);

	++i;
	v = { 0.3, 0, 1 };
	counts[i] = initVBO(VBO[i], VBN[i], VBT[i], IBO[i],
		"C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\obj\\Orange.obj",
		v, 0.3);
	...
	v = { 0.6, -3, 3 };
	counts[i] = initVBO(VBO[i], VBN[i], VBT[i], IBO[i],
		"C:\\Users\\ƒзарук\\source\\repos\\ind3\\ind3\\obj\\Bread.obj",
		v, 0.17);

	++i;
	v = { -3.5, 2, 3 };
	counts[i] = initVBO(VBO[i], VBN[i], VBT[i], IBO[i],
		"C:\\Users\\ƒзарук\\source\\repos\\ind3\\ind3\\obj\\Oreo.obj",
		v, 0.015);*/
}
...
void render()
{
	...
	_LoadImage("C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\textures\\Board.jpg");
	render1(Program1, VBO[i], VBN[i], VBT[i], IBO[i], l, m, counts[i], 1);

	++i;
	m.material_shininess = 10.0f;
	m.material_specular = { 0.7, 0.7, 0.7, 1.0 };
	_LoadImage("C:\\Users\\Dzaruk\\Desktop\\CG\\ind3\\ind3\\textures\\Orange.jpg");
	render1(Program1, VBO[i], VBN[i], VBT[i], IBO[i], l, m, counts[i], 1);
	...
	m.material_shininess = 10.0f;
	m.material_specular = { 0.7, 0.7, 0.7, 1.0 };
	_LoadImage("C:\\Users\\ƒзарук\\source\\repos\\ind3\\ind3\\textures\\Bread.jpg");
	render1(Program1, VBO[i], VBN[i], VBT[i], IBO[i], l, m, counts[i], 1);

	++i;
	m.material_shininess = 10.0f;
	m.material_specular = { 0.7, 0.7, 0.7, 1.0 };
	_LoadImage("C:\\Users\\ƒзарук\\source\\repos\\ind3\\ind3\\textures\\Oreo.jpg");
	render1(Program1, VBO[i], VBN[i], VBT[i], IBO[i], l, m, counts[i], 1);
	*/
	glutSwapBuffers();
}
